...
def testingNB():
	trainfname_n = 'D:\\python\python\\nbayes_calssify\\dataset\\negative.txt'
	trainfname_p = 'D:\\python\python\\nbayes_calssify\\dataset\\positive.txt'
	...
	testfname1 = 'D:\\python\python\\nbayes_calssify\\dataset\\testDataset1.txt'
	...
	testfname0 = 'D:\\python\python\\nbayes_calssify\\dataset\\testDataset0.txt'
...
def cross_validate():
	nfilename = 'D:\\python\python\\nbayes_calssify\\dataset\\negative.txt'
	pfilename = 'D:\\python\python\\nbayes_calssify\\dataset\\positive.txt'
